...
from rdb.exps.proxy_ird import ExperimentProxyIRD
...
if __name__ == "__main__":
    ...
    # Load parameters
    if not GCP_MODE:
        PARAMS = load_params("examples/params/proxy_ird_template.yaml")
    else:
        PARAMS = load_params("/dar_payload/rdb/examples/params/proxy_ird_template.yaml")
