...
def launch(params_dict):
    ...
    print(params_dict)
    save_params("examples/params/mcmc_params.yaml", params_dict)
    ...
    if LOCAL_MODE:
        ...
        launch_mode = mode.GCPMode(
            ...
            zone="us-west2-a",  # 40 c2 isntance, 6 n2 instance
            # instance_type="c2-standard-2",
    ...
    launch_api.run_command(
        command="bash /dar_payload/rdb/examples/cloud/run_mcmc.sh",
...
if __name__ == "__main__":
    ...
    # ========== Parameters =============
    template = load_params("examples/params/mcmc_template.yaml")
