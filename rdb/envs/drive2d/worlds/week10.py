...
class HighwayDriveWorld_Week10(HighwayDriveWorld):
    def __init__(
        self,
        main_state,
        goal_speed,
        ...
        # Add additional optimal/ego cars if provided
        if second_ego_state:
            second_car = car.OptimalControlCar(self, jnp.array(second_ego_state), horizon)
            vehicles.append(second_car)
        ...
        for ego_car in [main_car, second_car]:
            ego_car.max_throttle = max_throttle
            ego_car.max_steer = max_steer
            ego_car.max_brake = max_brake
            ego_car.max_speed = max_speed
...
class Week10_01(HighwayDriveWorld_Week10):
    """
    Highway merging scenario, with non-ego car ahead of it.
    """
    ...
    def __init__(self):
        ...
        # Add second optimal/ego car
        second_ego_state = [lane_width, 0, jnp.pi / 2, 0.7 * 1.25]
        ...
        super().__init__(
            ...
            obs_delta=[0.04, 0.1],
            second_ego_state=second_ego_state,
        )

class Week10_02(HighwayDriveWorld_Week10):
    """
